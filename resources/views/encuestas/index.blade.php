                    ...
                    <div class="card-header pt-10">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <h2 class="mb-1">Todas las encuenstas</h2>
                                <div class="text-muted fw-bold">
                                    Encuestas<span class="mx-3"></span> <span class="mx-3">
                                </div>
                            </div>
                            <!--end::Title-->
                        </div>
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_client">
                                    <i class="ki-duotone ki-plus fs-2"></i>Crear encuesta</button>
                                <!--begin::Menu 1-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">Unidad de Negocio</th>
                                    <th class="min-w-100px">Fecha de creación</th>
                                    <th class="min-w-100px">Fecha de duración</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <tr>
                                    <td class="d-flex align-items-center">
                                        <!--begin::User details-->
                                        <div class="d-flex flex-column">
                                            <span class="text-gray-800 text-hover-primary mb-1">Encuesta de satisfacción </span>
