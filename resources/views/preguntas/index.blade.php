                    ...
                    <div class="card-header pt-10">
                        <div class="d-flex align-items-center">
                            ...
                            <div class="d-flex flex-column">
                                <h2 class="mb-1">Todas las preguntas</h2>
                                <div class="text-muted fw-bold">
                                    Total de preguntas<span class="mx-3"></span> <span class="mx-3">
                                </div>
                            </div>
                            <!--end::Title-->
                        </div>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" data-kt-user-table-filter="search" class="form-control form-control-solid w-250px ps-13" placeholder="Buscar encuestas" />
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                ...
                                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_client">
                                    <i class="ki-duotone ki-plus fs-2"></i>Crear preguntas</button>
                                <!--begin::Menu 1-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            <thead>
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px">area de negocio</th>
                                    <th class="min-w-100px">encuesta asociada</th>
                            ...
                            <tbody class="text-gray-600 fw-semibold">
                                <tr>
                                    <td class="d-flex align-items-center">
                                        <!--begin::User details-->
                                        <div class="d-flex flex-column">
                                            <span class="text-gray-800 text-hover-primary mb-1">Pregunta 1: ¿Qué tan satisfecho estás con nuestro servicio? </span>
                                            
                                        </div>
                                        <!--begin::User details-->
                                    </td>
                                    <td>
                                        <span>J. Garcia Lopez</span>
                                    </td>
                                   <td>1 J. Garcia Lopez</td>
                                    <td>
                                        <span>20 Febrero del 2025</span>
                                    </td>
                                    <td class="text-end">
                                        ...
                                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                            ...
                                            <div class="menu-item px-3" style="display: flex; align-content: center; justify-content: center; align-items: center;">
                                                <a href="#" class="btn btn-warning px-5" data-bs-toggle="modal" data-bs-target="#kt_modal_edit_">Editar</a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3" style="display: flex; align-content: center; justify-content: center; align-items: center;">
                                               <form action="" method="POST" style="display:inline;">
            									@csrf
            									@method('DELETE')
            									<button type="submit" class="btn btn-danger px-3" onclick="return confirm('¿Estás seguro de que quieres eliminar este encuestas?')">Eliminar</button>
        									   </form>
                                            </div>
                                            <!--end::Menu item-->
                                        </div>
