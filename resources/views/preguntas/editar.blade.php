<div class="modal fade" id="kt_modal_edit_" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
           ...
           <form id="kt_modal_add_user_form" action="" class="form" method="POST">
    @csrf        
    @method('PUT')
    <div class="d-flex flex-column scroll-y px-5 px-lg-10" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
        ...
        <div class="fv-row mb-7">
            ...
            <input type="text" name="nombre:cliente" class="form-control  mb-3 mb-lg-0 form-control-solid" placeholder="Nombre de cliente" value="" required/>
        </div>
        <div class="fv-row mb-7">
